      ...
      <div className="">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            ...
            <a
              href="javascript:;"
              className="py-2.5 px-5 h-9 block w-fit bg-gradient-to-r from-[#04030e] via-[#14387f] to-[#00c8c4] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0"
            >
              Contact us
            </a>
          </div>
          ...
          <div className="lg:mx-auto text-left ">
            <h4 className="text-lg light:text-gray-900 dark:text-gray-300 font-medium mb-7">
              {" "}
             GYMFIT
            </h4>
          ...
          <div className="lg:mx-auto text-left ">
            ...
            <a
              href="javascript:;"
              className="flex items-center justify-center gap-2 border border-blue-600 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-blue-600 font-semibold transition-all duration-500 hover:bg-indigo-50"
            >
              Subscribe
              <ArrowRight />
            </a>
        ...
        <div className="py-7 border-t border-gray-400">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-gray-500 ">
              ©<a href="/">GYMFIT</a> 2024, All rights reserved.
            </span>
